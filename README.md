...
How to use:
API Key: Get a free Google AI Studio API Key from aistudio.google.com

Authenticate: Paste your Gemini API key once; it is stored safely in your browser's local storage.
